  ...
  return <main>
    <section className="hero shell">
      <div className="heroCopy">
        ...
        <h1>پرتال پژوهش دانشگاه‌ها،<em> زیر ذره‌بین داده.</em></h1>
        <p>مرجع ملی سنجش بلوغ و شفافیت پرتال معاونت پژوهش و فناوری؛ از ساختار معاونت و کتابخانه تا آزمایشگاه، صنعت و فناوری، سامانه‌ها و اسناد.</p>
      ...
      <div className="shell section">
        ...
        <div className="rankingStage">
          ...
          <aside>
            ...
            <p>این شاخص فقط بلوغ، یافت‌پذیری و شفافیت پرتال عمومی پژوهش و فناوری را می‌سنجد. پرتال فاقد Evidence کافی به‌جای امتیاز ساختگی، «رتبه‌ناپذیر» می‌ماند.</p>
